...
- A miner that has a pickaxe but no mine/quarry assignment self-claims a distinct starter quarry
  before it plans an upgrade, so profession/command-driven miners cannot remain idle. A miner
